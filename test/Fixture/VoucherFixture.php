...
return [
    ...
    'vo_voucher_gen_rule' => [
        ['voucher_gen_rule_id' => null, 'voucher_rule_name'   => 'Rule Fixture A' ,'voucher_rule_slug' => 'rule_fixture_a'  , 'voucher_padding_char' => 'a', 'voucher_prefix' => 'a_', 'voucher_suffix' => '_b', 'voucher_length' => 4, 'voucher_sequence_strategy' => 'SEQUENCE', 'date_created' => date('YYYY-MM-DD HH:MM:SS'), 'voucher_validate_rules' => 'always-valid']
