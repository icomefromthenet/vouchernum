...
class VoucherEntityTest extends \PHPUnit_Framework_TestCase
{
    ...
    //     $sequence = $this->getMock('IComeFromTheNet\VoucherNum\Strategy\SequenceStrategyInterface');
    //     $formatter = $this->getMock('IComeFromTheNet\VoucherNum\Formatter\FormatterInterface');
