...
class VoucherBuilderTest extends VoucherTestAbstract
{
    ...
    public function testVoucherGroupBuilder()
    {
        ...
        $oBuilder = $oContainer->getGateway(VoucherContainer::DB_TABLE_VOUCHER_GROUP)->getEntityBuilder();
    ...
    {
        $oContainer = $this->getContainer();
        $oBuilder =  $oContainer->getGateway(VoucherContainer::DB_TABLE_VOUCHER_RULE)->getEntityBuilder();
        $sAlias = $oBuilder->getTableQueryAlias();
    ...
    {
        $oContainer = $this->getContainer();
        $oBuilder =  $oContainer->getGateway(VoucherContainer::DB_TABLE_VOUCHER_INSTANCE)->getEntityBuilder();
        $sAlias = $oBuilder->getTableQueryAlias();
    ...
    {
        $oContainer = $this->getContainer();
        $oBuilder =  $oContainer->getGateway(VoucherContainer::DB_TABLE_VOUCHER_TYPE)->getEntityBuilder();
        $sAlias = $oBuilder->getTableQueryAlias();
